...
## 폴더 구성
- `board/skill-quest-board.html` — 웹 보드(캐릭터 시트·성장 코드 입력·스킬 도감). 참가자는 안내받은 링크로 접속하며, 이 파일은 배포용 원본입니다.
- `doc/slides/index.html` — 실습 전 이론교육 슬라이드(이론 5장 ↔ 실습 7레벨 매핑). 브라우저로 열거나 GitHub Pages로 서빙합니다.
